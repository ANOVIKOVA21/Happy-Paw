    ...
    class ProductInfo extends HTMLElement {
      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          this.querySelector(`#Volume-Note-${this.dataset.section}`)?.classList.remove(
            'hidden'
          );
      ...
      fetchQuantityRules() {
        ...
        this.querySelector('.quantity__rules-cart .loading__spinner').classList.remove(
          'hidden'
        );
        return fetch(
          ...
          .finally(() =>
            this.querySelector('.quantity__rules-cart .loading__spinner').classList.add(
              'hidden'
            )
          );
      }
